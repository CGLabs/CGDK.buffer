...
1. CGD.buffer 사용법 및 주의 사항
   ...
   - CGD.buffer는 C#의 리플렉션(Reflection)을 사용하여 구현하여 편리한 사용이 가능합니다.
   - CGD.buffer를 사용하기 위해서는 간단히 'CGDbuffer(for CSharp).dll'파일을 
     사용하고자하는 Project의 Refence에 추가만 하시면 됩니다.
...
2. 추가적 설명
   ...
   - C#의 사용상 다른 컴파일 옵션으로 컴파일이 필요한 경우 연락주시면 최대한
     해당 버전을 제공하겠습니다.
