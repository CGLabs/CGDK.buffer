@ECHO OFF
..\..\vcpkg_installed\x64-windows\x64-windows\tools\flatbuffers\flatc -c messages_test_1.fbs
..\..\vcpkg_installed\x64-windows\x64-windows\tools\flatbuffers\flatc -c messages_test_2.fbs
