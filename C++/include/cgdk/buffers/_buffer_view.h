...
public:
	...
	constexpr void				swap(self_t& _rhs) noexcept				{ element_t* a = this->data_; this->data_ = _rhs.data_; _rhs.data_ = a; auto b = this->size_; this->size_ = _rhs.size_; _rhs.size_ = b; }
	template <class T>
	constexpr void				copy_from(const _buffer_view<T>& _source) { memcpy(this->data_, _source.data(), _source.size_); this->size_ = _source.size_; }
